...
set guifont=Courier_New:h17:cDEFAULT
set guioptions=egt
set helplang=fr
set path=.,,,**
set shiftwidth=4
...
1
normal! 0
lcd ~\work\Learning\portfolio
wincmd w
argglobal
if bufexists("~\work\Learning\portfolio\index.php") | buffer ~\work\Learning\portfolio\index.php | else | edit ~\work\Learning\portfolio\index.php | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((4 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
...
exe 'vert 2resize ' . ((&columns * 94 + 57) / 115)
tabnext
edit ~\work\Learning\portfolio\NetrwTreeListing
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 28 + 57) / 115)
exe 'vert 2resize ' . ((&columns * 86 + 57) / 115)
argglobal
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <MiddleMouse> <Plug>IMiddlemouse
...
wincmd w
argglobal
if bufexists("~\work\Learning\portfolio\models\article.php") | buffer ~\work\Learning\portfolio\models\article.php | else | edit ~\work\Learning\portfolio\models\article.php | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 86 + 57) / 115)
tabnext
edit ~\work\Learning\portfolio\article\index.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((25 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
normal! 0242|
tabnext
edit ~\work\Learning\portfolio\css\index.css
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 186 - ((20 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
186
...
tabnext 4
set stal=1
badd +65 ~\work\Learning\portfolio\index.html
badd +0 ~\work\Learning\portfolio\models\article.php
badd +0 ~\work\Learning\portfolio\index.php
badd +0 ~\work\Learning\portfolio\article\index.php
badd +0 ~\work\Learning\portfolio\css\index.css
